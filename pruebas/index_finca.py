...
MONGO_BASEDATOS="VideoFinca"
MONGO_COLECCION_ADMIN="Admin"
MONGO_COLECCION_FINCA="Finca"
MONGO_COLECCION_PLANTILLA="Plantilla"
MONGO_COLECCION_PROPIETARIO="Propietario"

cliente=pymongo.MongoClient(MONGO_URI,serverSelectionTimeoutMS=MONGO_TIEMPO_FUERA)
baseDatos=cliente[MONGO_BASEDATOS]
coleccion_ADMIN=baseDatos[MONGO_COLECCION_ADMIN]
coleccion_FINCA=baseDatos[MONGO_COLECCION_FINCA]
coleccion_PLANTILLA=baseDatos[MONGO_COLECCION_PLANTILLA]
coleccion_PROPIETARIO=baseDatos[MONGO_COLECCION_PROPIETARIO]
...
def mostrarDatos(id_finca="",id_plantilla="",id_seccion=""):
    objetoBuscar={}
    if len(id_finca)!=0:
        objetoBuscar["_id"]=nombre
    if len(id_plantilla)!=0:
