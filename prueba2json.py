...
#Ejemplo del json Finca-Plantilla-Propietario

ejemplo_datajson=[
  {
    "_id": "Finca0001",
    "Admin": "Admin01",
    "Direccion": "Calle Las Palomas 645",
    "Nombre": "Finca Las Palomas",
    "Plantillas": [
      {
        "_id": "Plantilla0001",
        "Finca": "Finca0001",
...
def factura_excel(tipo_moneda='S/.'):#euro va ala derecha
    total_monto=0
    book=Workbook()
    sheet= book.active
    ...
    #----------------------------------------------------------------
    for j in range(2):
        nombre_seccion=datajson["Seccion"][j]["ID_Seccion"]
        b=datajson["Seccion"][j]['Subsecciones']
