...
def lista_json(client):
    ...
    print('=========== Lista prueba ==============',lista_prueba)
...
def principalv2(json,tipo_moneda='S/.',mensaje_extra='Mensaje extra al pie de pagina',n_excel=1):
    ...
    #for i in range(l): 
        ...
        logo = openpyxl.drawing.image.Image('C:/Users/DELL/Desktop/angular/mongodb/principal/LOGO_VIDEOFINCA.png')
        logo_pil = Image.open('C:/Users/DELL/Desktop/angular/mongodb/principal/LOGO_VIDEOFINCA.png')
        logo_pil = logo_pil.resize((140,80))
